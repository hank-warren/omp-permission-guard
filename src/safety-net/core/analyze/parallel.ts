...
const REASON_PARALLEL_RM = "parallel rm -rf with dynamic input is dangerous. Use explicit file list instead.";
const REASON_PARALLEL_SHELL = "parallel with shell -c can execute arbitrary commands from dynamic input.";
...
export function analyzeParallel(tokens: readonly string[], context: ParallelAnalyzeContext): string | null {
